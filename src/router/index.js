 ...
 * alwaysShow: true               if set true, will always show the root menu 如果设置为真，将始终显示根菜单
 ...
 * redirect: noRedirect           if set noRedirect will no redirect in the breadcrumb 如果设置为no redirect，则不会在breadcrumb中重定向
 ...
 * meta : {
    ...
    noCache: true                if set true, the page will no be cached(default is false) 如果设置为true，则不会缓存该页（默认值为false）
    affix: true                  if set true, the tag will affix in the tags-view 如果设置为真，则标签将粘贴在“标签”视图中。
